...
public class InternalJsonWriterTest {
  ...
  public void testSimpleValues() {
    assertEquals("true", JsonWriter.string().value(true).write());
    assertEquals("null", JsonWriter.string().nul().write());
    assertEquals("1.0", JsonWriter.string().value(1.0).write());
    assertEquals("1.0", JsonWriter.string().value(1.0f).write());
    assertEquals("1", JsonWriter.string().value(1).write());
    assertEquals("\"abc\"", JsonWriter.string().value("abc").write());
  }
  ...
  public void testNull() {
    assertEquals("null", JsonWriter.string().value((String)null).write());
    assertEquals("null", JsonWriter.string().value((Number)null).write());
    assertEquals("null", JsonWriter.string().nul().write());
    assertEquals("[null]", JsonWriter.string().array().value((String)null).end().write());
    assertEquals("[null]", JsonWriter.string().array().value((Number)null).end().write());
    assertEquals("[null]", JsonWriter.string().array().nul().end().write());
    assertEquals("{\"a\":null}", JsonWriter.string().object().value("a", (String)null).end().write());
    assertEquals("{\"a\":null}", JsonWriter.string().object().value("a", (Number)null).end().write());
    assertEquals("{\"a\":null}", JsonWriter.string().object().nul("a").end().write());
  }
  ...
  public void testArray() {
    String json = JsonWriter.string().array().value(true).value(false).value(true).end().write();
  ...
  public void testArrayEmpty() {
    String json = JsonWriter.string().array().end().write();
    assertEquals("[]", json);
  }
  ...
  public void testArrayOfEmpty() {
    String json = JsonWriter.string().array().array().end().array().end().end().write();
    assertEquals("[[],[]]", json);
  }
  ...
  public void testObject() {
    String json = JsonWriter.string().object().value("a", true).value("b", false).value("c", true).end().write();
  ...
  public void testNestedObject() {
    String json = JsonWriter.string().object().object("a").value("b", false).value("c", true).end().end().write();
  ...
  public void testFailureNoKeyInObject() {
    try {
      JsonWriter.string().object().value(true).end().write();
      fail();
  ...
  public void testFailureNoKeyInObject2() {
    try {
      JsonWriter.string().object().value("a", 1).value(true).end().write();
      fail();
    } catch (JsonWriterException e) {
      // OK
    }
  ...
  public void testFailureKeyInArray() {
    try {
      JsonWriter.string().array().value("x", true).end().write();
      fail();
    } catch (JsonWriterException e) {
      // OK
    }
  ...
  public void testFailureKeyInArray2() {
    try {
      JsonWriter.string().array().value(1).value("x", true).end().write();
      fail();
    } catch (JsonWriterException e) {
      // OK
    }
  ...
  public void testFailureNotFullyClosed() {
    try {
      JsonWriter.string().array().value(1).write();
      fail();
    } catch (JsonWriterException e) {
      // OK
    }
  ...
  public void testFailureMoreThanOneRoot() {
    try {
      JsonWriter.string().value(1).value(1).write();
      fail();
    } catch (JsonWriterException e) {
      // OK
    }
  ...
  public void testFailureMoreThanOneRoot2() {
    try {
      JsonWriter.string().array().value(1).end().value(1).write();
      fail();
    } catch (JsonWriterException e) {
      // OK
    }
  ...
  public void testFailureMoreThanOneRoot3() {
    try {
      JsonWriter.string().array().value(1).end().array().value(1).end().write();
      fail();
    } catch (JsonWriterException e) {
      // OK
    }
