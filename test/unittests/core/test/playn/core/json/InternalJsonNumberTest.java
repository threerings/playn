...
public class InternalJsonNumberTest {
  ...
  public void testBasicNumberWrite() {
    ...
    assertEquals("[1,1.0,1.0]", JsonWriter.string().array(array).write());
  }
  ...
  public void testLargeIntWrite() {
    ...
    assertEquals("[-300000000,300000000]", JsonWriter.string().array(array).write());
  }
  ...
  public void testLongWrite() {
    ...
    assertEquals("[1,-3000000000,3000000000]", JsonWriter.string().array(array).write());
  }
  ...
  public void testBigIntWrite() {
    ...
    assertEquals("[1,-30000000000000000000,30000000000000000000]", JsonWriter.string().array(array).write());
  }
  ...
  public void testAroundEdges() throws JsonParserException {
    ...
    String json = JsonWriter.string().array(array).write();
    ...
    String json2 = JsonWriter.string().array(array2).write();
