...
//    }
    ...
    for(int i = 0; i < VERTEX_ATTRIB_ARRAY_COUNT; i++) {
      ...
      if (enabled != 0 && (useNioBuffer & mask) != 0) {
        ...
        if (previousNio != null && previousNio.nioBuffer == data.nioBuffer && previousNio.nioBufferLimit >= data.nioBufferLimit) {
          ...
          gl.vertexAttribPointer(i, data.size, data.type, data.normalize, data.stride, data.nioBufferPosition * previousElementSize);
        } else {
          ...
          if (data.nioBufferPosition * elementSize < data.stride) {
            ...
            gl.bufferData(ARRAY_BUFFER, getTypedArray(data.nioBuffer, data.type, data.nioBufferLimit * elementSize), STREAM_DRAW);
            gl.vertexAttribPointer(i, data.size, data.type, data.normalize, data.stride, data.nioBufferPosition * elementSize);
            previousNio = data;
  ...
  public void glDrawElements(int mode, int count, int type, Buffer indices) {
    ...
    gl.bufferData(ELEMENT_ARRAY_BUFFER, getTypedArray(indices, type, count * getTypeSize(type)), STREAM_DRAW);
...
//  }
  ...
  public void glTexSubImage2D(int target, int level, int xoffset, int yoffset,
    ...
    gl.texSubImage2D(target, level, xoffset, yoffset, width, height, format, type, getTypedArray(pixels, type, -1));
  }
  ...
  public int glGetUniformLocation(int program, String name) {
    return createObject(gl.getUniformLocation((WebGLProgram) getProgram(program), name), WebGLObjectType.UNIFORM_LOCATION);
  }
  ...
  public void glUniform2fv(int location, int count, FloatBuffer v) {
    gl.uniform2fv(getUniformLocation(location), (Float32Array) getTypedArray(v, GL_FLOAT, count * 2 * 4));
  }
  ...
  public void glUniform4fv(int location, int count, FloatBuffer v) {
    gl.uniform4fv(getUniformLocation(location), (Float32Array) getTypedArray(v, GL_FLOAT, 4 * 4 * count));
  }
  ...
  public void glUniformMatrix4fv(int location, int count, boolean transpose, FloatBuffer value) {
    gl.uniformMatrix4fv(getUniformLocation(location), transpose, (Float32Array) getTypedArray(value, GL_FLOAT, count * 16 * 4));
  }
  ...
  @Override
  public void glCompressedTexSubImage3D(int arg0, int arg1, int arg2, int arg3,
  ...
  @Override
  public void glFramebufferTexture3D(int target, int attachment, int textarget,
  ...
  @Override
  public void glGetAttachedShaders(int program, int maxcount, IntBuffer count,
		  IntBuffer shaders) {
	  throw new RuntimeException("NYI");
  ...
  @Override
  public void glTexSubImage3D(int arg0, int arg1, int arg2, int arg3, int arg4,
		  int arg5, int arg6, int arg7, int arg8, int arg9, Buffer arg10)
				  throws RuntimeException {
	  throw new RuntimeException("NYI");
  ...
  @Override
  public void glCompressedTexSubImage2D(int arg0, int arg1, int arg2, int arg3,
		  int arg4, int arg5, int arg6, int arg7, int arg8)
				  throws RuntimeException {
	  throw new RuntimeException("NYI");
  ...
  public void glTexSubImage2D(int arg0, int arg1, int arg2, int arg3, int arg4,
		  int arg5, int arg6, int arg7, int arg8) throws RuntimeException {
	  throw new RuntimeException("NYI");
