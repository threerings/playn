...
public class AndroidGL20 implements GL2ES2 {
  ...
  public GL2ES1 getGL2ES1() throws GLException {
    throw new GLException("Not a GL22ES1 implementation!");
  }
  ...
  public Object getPlatformGLExtensions() {
    String extensions = GLES20.glGetString(GL2ES2.GL_EXTENSIONS);
    return extensions;
  }
  ...
  @Override
  public void glBlendEquation(int mode) throws GLException {
  ...
  public void glCompressedTexImage2D(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5,
      int arg6, long arg7) throws GLException {
    throw new GLException("glCompressedTexImage2D(int, int, int, int, int, int, int, long)"
        + "not supported.");
  }
  ...
  public void glCompressedTexImage3D(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5,
    ...
    throw new GLException("glCompressedTexImage3D not supported.");
  }

  @Override
  public void glCompressedTexImage3D(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5,
      int arg6, int arg7, long arg8) throws GLException {
    throw new GLException("glCompressedTexImage3D not supported.");
  }
  ...
  public void glCompressedTexSubImage2D(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5,
      int arg6, int arg7, long arg8) throws GLException {
    throw new GLException("glCompressedSubTexImage2D(int, int, int, int, int, int, int, int, long)"
        + "not supported.");
  }

  @Override
  public void glCompressedTexSubImage3D(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5,
      int arg6, int arg7, int arg8, int arg9, Buffer arg10) throws GLException {
    throw new GLException("glCompressedTexSubImage3D not supported.");
  }

  @Override
  public void glCompressedTexSubImage3D(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5,
      int arg6, int arg7, int arg8, int arg9, long arg10) throws GLException {
    throw new GLException("glCompressedTexSubImage3D not supported.");
  }
  ...
  public void glCopyTexSubImage3D(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5,
      int arg6, int arg7, int arg8) throws GLException {
    throw new GLException("glCopyTexSubImage3D not supported.");
  }
  ...
  @Override
  public int glGetBoundBuffer(int arg0) throws GLException {
    throw new GLException("glGetBoundBuffer not supported in GLES 2.0");
  }
  ...
  public void glGetProgramBinary(int arg0, int arg1, int[] arg2, int arg3, int[] arg4, int arg5,
      Buffer arg6) throws GLException {
    throw new GLException("glGetProgramBinary not supported.");
  }
  ...
  @Override
  public ByteBuffer glMapBuffer(int arg0, int arg1) throws GLException {
    throw new GLException("glMapBuffer() not supported.");
  }
  ...
  @Override
  public void glProgramBinary(int arg0, int arg1, Buffer arg2, int arg3) throws GLException {
    throw new GLException("glProgramBinary() not supported.");
  }
  ...
  public void glReadPixels(int x, int y, int width, int height, int format, int type,
      long pixelsBufferOffset) throws GLException {
    throw new GLException("Not supported.  Please call glReadPixels(int, int, int, int, int, int, Buffer) instead");
  }
  ...
  public void glTexImage3D(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6,
      int arg7, int arg8, Buffer arg9) throws GLException {
    throw new GLException("glTexImage3D not supported!");
  }

  @Override
  public void glTexImage3D(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6,
      int arg7, int arg8, long arg9) throws GLException {
    throw new GLException("glTexImage3D not supported!");
  }
  ...
  public void glTexSubImage2D(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6,
      int arg7, long arg8) throws GLException {
    throw new GLException("glTexSubImage2D(int, int, int, int, int, int," +
    		" int, int, long) not supported.");
  }

  @Override
  public void glTexSubImage3D(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6,
      int arg7, int arg8, int arg9, Buffer arg10) throws GLException {
    throw new GLException("glTexSubImage3D not supported!");

  }

  @Override
  public void glTexSubImage3D(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6,
      int arg7, int arg8, int arg9, long arg10) throws GLException {
    throw new GLException("glTexSubImage3D not supported!");

  }

  @Override
  public void glUniform(GLUniformData data) throws GLException {
    throw new GLException("glUniform(GLUniformData) not supported!");
    //TODO(jonagill) Implement this if I have some free time.
  }
  ...
  @Override
  public boolean glUnmapBuffer(int arg0) throws GLException {
    throw new GLException("glUnmapBuffer() not supported.");
  }
  ...
  @Override
  public void glVertexAttribPointer(GLArrayData data) {
    // TODO Test
    glVertexAttribPointer(data.getIndex(), data.getComponentSize(), data.getComponentType(),
        data.getNormalized(), data.getStride(), data.getBuffer());
  }
